...
export default function ExplorePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col">
      ...
      <div className="sticky top-16 z-40 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 shadow-sm">
        <div className="max-w-[1600px] mx-auto px-6 py-4 flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="relative w-full sm:max-w-md">
            ...
            <Input 
              ...
              className="pl-9 bg-slate-950 focus-visible:ring-primary/50 shadow-sm"
              value={searchQuery}
          ...
          <div className="flex gap-2 w-full sm:w-auto overflow-x-auto pb-2 sm:pb-0 hide-scrollbar items-center">
            ...
            <select 
              ...
              className="ml-auto sm:ml-2 h-9 items-center justify-center rounded-md border border-input bg-slate-950 px-3 py-1 text-sm shadow-sm transition-colors focus:outline-none focus:ring-1 focus:ring-ring"
            >
      ...
      <main className="flex-1 max-w-[1600px] w-full mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-400 mt-2">Discover insights and analytics generated by your team.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {isLoading ? (
            ...
            <div className="col-span-full flex justify-center p-12 text-slate-400">
