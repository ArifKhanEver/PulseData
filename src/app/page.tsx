...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="bg-slate-950/50 backdrop-blur border-slate-800 hover:border-accent/40 transition-all duration-300 hover:shadow-lg">
                <CardHeader>
                  <div className="mb-4 p-3 bg-slate-800 rounded-lg inline-flex w-fit shadow-sm">{feature.icon}</div>
      ...
      <section className="py-24 px-6 bg-cyan-500 text-cyan-400-foreground relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-primary-foreground/20">
            {[
              ...
              <div key={i} className="py-6 md:py-0 space-y-2 hover:scale-105 transition-transform duration-300">
                ...
                <div className="text-cyan-400-foreground/80 font-medium uppercase tracking-wider text-sm">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={i} className="border-none shadow-lg bg-slate-800/10 hover:bg-slate-800/20 transition-colors duration-300">
                <CardContent className="pt-8 space-y-6">
                  <Quote className="w-10 h-10 text-accent/40" />
                  <p className="text-lg italic text-slate-100/80 leading-relaxed">"{testimonial.quote}"</p>
                  <div>
      ...
      <section className="py-32 px-6 bg-gradient-to-br from-secondary/40 to-background border-t border-primary/5">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-xl text-slate-400">Join over 10,000 companies that trust PulseData for their business intelligence.</p>
