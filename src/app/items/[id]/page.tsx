        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1 flex items-center gap-4 text-sm">
              ...
              <span className="px-2.5 py-0.5 rounded-full bg-primary/10 text-primary font-medium text-xs border border-primary/20">{item.category}</span>
            </p>
          </div>
        </div>

        <div className="grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2 border-primary/10 shadow-xl shadow-primary/5 bg-background/60 backdrop-blur-xl">
            <CardHeader>
